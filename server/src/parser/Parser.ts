...
class Parser {
  ...
  private static properArgType(arg: string): number | string {
    if (isNaN(Number(arg)) || arg === "000000") {
      return arg;
    }
    return Number(arg);
  }

  private static genOutput(
    status: Status,
    cmd: Array<string>,
    num: number
  ): ParserOutput {
    if (status !== Status.OK) {
      ...
      if (cmd[0] === "draw_text") num = cmd.length;
      for (let i = 1; i < num; i++) {
  ...
  private parseClearDisplay(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 2))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
  ...
  private parseDrawPixel(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 4))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (
      Parser.checkReg(cmd, /^draw_pixel [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/)
    ) {
  ...
  private parseDrawLine(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 6))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (
      Parser.checkReg(
        cmd,
        /^draw_line [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
  ...
  private parseDrawRectangle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 6))
      ...
      Parser.checkReg(
        cmd,
        /^draw_rectangle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 6);
    }
  ...
  private parseFillRectangle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 6))
      ...
      Parser.checkReg(
        cmd,
        /^fill_rectangle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 6);
    }
  ...
  private parseDrawEllipse(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 6))
      ...
      Parser.checkReg(
        cmd,
        /^draw_ellipse [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 6);
    }
  ...
  private parseFillEllipse(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 6))
      ...
      Parser.checkReg(
        cmd,
        /^fill_ellipse [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 6);
    }
  ...
  private parseDrawCircle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 5))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (
      Parser.checkReg(
        cmd,
        /^draw_circle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
  ...
  private parseFillCircle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 5))
      ...
      Parser.checkReg(
        cmd,
        /^fill_circle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 5);
    }
  ...
  private parseDrawRoundedRectangle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 7))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (
      Parser.checkReg(
        cmd,
        /^draw_rounded_rectangle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
  ...
  private parseFillRoundedRectangle(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 7))
      ...
      Parser.checkReg(
        cmd,
        /^fill_rounded_rectangle [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 7);
    }
  ...
  private parseDrawText(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 7))
      ...
      Parser.checkReg(
        cmd,
        /^draw_text [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6} [0-9]{1,6} [0-9]{1,6} .+$/
      )
    ) {
      return Parser.genOutput(Status.OK, cmd, 7);
    }
  ...
  private parseDrawImage(cmd: Array<string>): ParserOutput {
    ...
    if (
      Parser.checkReg(
        cmd,
        /^draw_image [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [0-9]{1,6} [A-F0-9]{6}(?: [A-F0-9]{6})*$/
      )
    ) {
      const num: number = Number(cmd[3]) * Number(cmd[4]) + 5;
      if (Parser.wrongCmdLen(cmd, num))
        return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
  ...
  private parseGetWidth(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 1))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (Parser.checkReg(cmd, /^get_width$/))
      return Parser.genOutput(Status.OK, cmd, 0);
    return Parser.genOutput(Status.CMD_FORMAT_ERROR, cmd, 0);
  }
  ...
  private parseGetHeight(cmd: Array<string>): ParserOutput {
    if (Parser.wrongCmdLen(cmd, 1))
      return Parser.genOutput(Status.BAD_ARGS, cmd, 0);
    else if (Parser.checkReg(cmd, /^get_height/))
      return Parser.genOutput(Status.OK, cmd, 0);
    return Parser.genOutput(Status.CMD_FORMAT_ERROR, cmd, 0);
  }
}
